...
void AddRoundKey(uchar state[], uint w[])
{
   uchar subkey[4];
   ...
   subkey[2] = w[0] >> 8;
   subkey[3] = w[0];
   state[0 * 4 + 0] ^= subkey[0];
   state[1 * 4 + 0] ^= subkey[1];
   state[2 * 4 + 0] ^= subkey[2];
   state[3 * 4 + 0] ^= subkey[3];
   // Subkey 2
   subkey[0] = w[1] >> 24;
   subkey[1] = w[1] >> 16;
   subkey[2] = w[1] >> 8;
   subkey[3] = w[1];
   state[0 * 4 + 1] ^= subkey[0];
   state[1 * 4 + 1] ^= subkey[1];
   state[2 * 4 + 1] ^= subkey[2];
   state[3 * 4 + 1] ^= subkey[3];
   // Subkey 3
   subkey[0] = w[2] >> 24;
   subkey[1] = w[2] >> 16;
   subkey[2] = w[2] >> 8;
   subkey[3] = w[2];
   state[0 * 4 + 2] ^= subkey[0];
   state[1 * 4 + 2] ^= subkey[1];
   state[2 * 4 + 2] ^= subkey[2];
   state[3 * 4 + 2] ^= subkey[3];
   // Subkey 4
   subkey[0] = w[3] >> 24;
   subkey[1] = w[3] >> 16;
   subkey[2] = w[3] >> 8;
   subkey[3] = w[3];
   state[0 * 4 + 3] ^= subkey[0];
   state[1 * 4 + 3] ^= subkey[1];
   state[2 * 4 + 3] ^= subkey[2];
   state[3 * 4 + 3] ^= subkey[3];
}
...
{
   state[0 * 4 + 0] = aes_sbox[state[0 * 4 + 0] >> 4][state[0 * 4 + 0] & 0x0F];
   state[0 * 4 + 1] = aes_sbox[state[0 * 4 + 1] >> 4][state[0 * 4 + 1] & 0x0F];
   state[0 * 4 + 2] = aes_sbox[state[0 * 4 + 2] >> 4][state[0 * 4 + 2] & 0x0F];
   state[0 * 4 + 3] = aes_sbox[state[0 * 4 + 3] >> 4][state[0 * 4 + 3] & 0x0F];
   state[1 * 4 + 0] = aes_sbox[state[1 * 4 + 0] >> 4][state[1 * 4 + 0] & 0x0F];
   state[1 * 4 + 1] = aes_sbox[state[1 * 4 + 1] >> 4][state[1 * 4 + 1] & 0x0F];
   state[1 * 4 + 2] = aes_sbox[state[1 * 4 + 2] >> 4][state[1 * 4 + 2] & 0x0F];
   state[1 * 4 + 3] = aes_sbox[state[1 * 4 + 3] >> 4][state[1 * 4 + 3] & 0x0F];
   state[2 * 4 + 0] = aes_sbox[state[2 * 4 + 0] >> 4][state[2 * 4 + 0] & 0x0F];
   state[2 * 4 + 1] = aes_sbox[state[2 * 4 + 1] >> 4][state[2 * 4 + 1] & 0x0F];
   state[2 * 4 + 2] = aes_sbox[state[2 * 4 + 2] >> 4][state[2 * 4 + 2] & 0x0F];
   state[2 * 4 + 3] = aes_sbox[state[2 * 4 + 3] >> 4][state[2 * 4 + 3] & 0x0F];
   state[3 * 4 + 0] = aes_sbox[state[3 * 4 + 0] >> 4][state[3 * 4 + 0] & 0x0F];
   state[3 * 4 + 1] = aes_sbox[state[3 * 4 + 1] >> 4][state[3 * 4 + 1] & 0x0F];
   state[3 * 4 + 2] = aes_sbox[state[3 * 4 + 2] >> 4][state[3 * 4 + 2] & 0x0F];
   state[3 * 4 + 3] = aes_sbox[state[3 * 4 + 3] >> 4][state[3 * 4 + 3] & 0x0F];
}

void InvSubBytes(uchar state[])
{
   state[0 * 4 + 0] = aes_invsbox[state[0 * 4 + 0] >> 4][state[0 * 4 + 0] & 0x0F];
   state[0 * 4 + 1] = aes_invsbox[state[0 * 4 + 1] >> 4][state[0 * 4 + 1] & 0x0F];
   state[0 * 4 + 2] = aes_invsbox[state[0 * 4 + 2] >> 4][state[0 * 4 + 2] & 0x0F];
   state[0 * 4 + 3] = aes_invsbox[state[0 * 4 + 3] >> 4][state[0 * 4 + 3] & 0x0F];
   state[1 * 4 + 0] = aes_invsbox[state[1 * 4 + 0] >> 4][state[1 * 4 + 0] & 0x0F];
   state[1 * 4 + 1] = aes_invsbox[state[1 * 4 + 1] >> 4][state[1 * 4 + 1] & 0x0F];
   state[1 * 4 + 2] = aes_invsbox[state[1 * 4 + 2] >> 4][state[1 * 4 + 2] & 0x0F];
   state[1 * 4 + 3] = aes_invsbox[state[1 * 4 + 3] >> 4][state[1 * 4 + 3] & 0x0F];
   state[2 * 4 + 0] = aes_invsbox[state[2 * 4 + 0] >> 4][state[2 * 4 + 0] & 0x0F];
   state[2 * 4 + 1] = aes_invsbox[state[2 * 4 + 1] >> 4][state[2 * 4 + 1] & 0x0F];
   state[2 * 4 + 2] = aes_invsbox[state[2 * 4 + 2] >> 4][state[2 * 4 + 2] & 0x0F];
   state[2 * 4 + 3] = aes_invsbox[state[2 * 4 + 3] >> 4][state[2 * 4 + 3] & 0x0F];
   state[3 * 4 + 0] = aes_invsbox[state[3 * 4 + 0] >> 4][state[3 * 4 + 0] & 0x0F];
   state[3 * 4 + 1] = aes_invsbox[state[3 * 4 + 1] >> 4][state[3 * 4 + 1] & 0x0F];
   state[3 * 4 + 2] = aes_invsbox[state[3 * 4 + 2] >> 4][state[3 * 4 + 2] & 0x0F];
   state[3 * 4 + 3] = aes_invsbox[state[3 * 4 + 3] >> 4][state[3 * 4 + 3] & 0x0F];
}
...
void MixColumns(uchar state[])
{
   ...
   col[2] = state[2 * 4 + 0];
   col[3] = state[3 * 4 + 0];
   state[0 * 4 + 0] = gf_mul[col[0]][0];
   state[0 * 4 + 0] ^= gf_mul[col[1]][1];
   state[0 * 4 + 0] ^= col[2];
   state[0 * 4 + 0] ^= col[3];
   state[1 * 4 + 0] = col[0];
   state[1 * 4 + 0] ^= gf_mul[col[1]][0];
   state[1 * 4 + 0] ^= gf_mul[col[2]][1];
   state[1 * 4 + 0] ^= col[3];
   state[2 * 4 + 0] = col[0];
   state[2 * 4 + 0] ^= col[1];
   state[2 * 4 + 0] ^= gf_mul[col[2]][0];
   state[2 * 4 + 0] ^= gf_mul[col[3]][1];
   state[3 * 4 + 0] = gf_mul[col[0]][1];
   state[3 * 4 + 0] ^= col[1];
   state[3 * 4 + 0] ^= col[2];
   state[3 * 4 + 0] ^= gf_mul[col[3]][0];
   // Column 2
   col[0] = state[0 * 4 + 1];
   col[1] = state[1 * 4 + 1];
   col[2] = state[2 * 4 + 1];
   col[3] = state[3 * 4 + 1];
   state[0 * 4 + 1] = gf_mul[col[0]][0];
   state[0 * 4 + 1] ^= gf_mul[col[1]][1];
   state[0 * 4 + 1] ^= col[2];
   state[0 * 4 + 1] ^= col[3];
   state[1 * 4 + 1] = col[0];
   state[1 * 4 + 1] ^= gf_mul[col[1]][0];
   state[1 * 4 + 1] ^= gf_mul[col[2]][1];
   state[1 * 4 + 1] ^= col[3];
   state[2 * 4 + 1] = col[0];
   state[2 * 4 + 1] ^= col[1];
   state[2 * 4 + 1] ^= gf_mul[col[2]][0];
   state[2 * 4 + 1] ^= gf_mul[col[3]][1];
   state[3 * 4 + 1] = gf_mul[col[0]][1];
   state[3 * 4 + 1] ^= col[1];
   state[3 * 4 + 1] ^= col[2];
   state[3 * 4 + 1] ^= gf_mul[col[3]][0];
   // Column 3
   col[0] = state[0 * 4 + 2];
   col[1] = state[1 * 4 + 2];
   col[2] = state[2 * 4 + 2];
   col[3] = state[3 * 4 + 2];
   state[0 * 4 + 2] = gf_mul[col[0]][0];
   state[0 * 4 + 2] ^= gf_mul[col[1]][1];
   state[0 * 4 + 2] ^= col[2];
   state[0 * 4 + 2] ^= col[3];
   state[1 * 4 + 2] = col[0];
   state[1 * 4 + 2] ^= gf_mul[col[1]][0];
   state[1 * 4 + 2] ^= gf_mul[col[2]][1];
   state[1 * 4 + 2] ^= col[3];
   state[2 * 4 + 2] = col[0];
   state[2 * 4 + 2] ^= col[1];
   state[2 * 4 + 2] ^= gf_mul[col[2]][0];
   state[2 * 4 + 2] ^= gf_mul[col[3]][1];
   state[3 * 4 + 2] = gf_mul[col[0]][1];
   state[3 * 4 + 2] ^= col[1];
   state[3 * 4 + 2] ^= col[2];
   state[3 * 4 + 2] ^= gf_mul[col[3]][0];
   // Column 4
   col[0] = state[0 * 4 + 3];
   col[1] = state[1 * 4 + 3];
   col[2] = state[2 * 4 + 3];
   col[3] = state[3 * 4 + 3];
   state[0 * 4 + 3] = gf_mul[col[0]][0];
   state[0 * 4 + 3] ^= gf_mul[col[1]][1];
   state[0 * 4 + 3] ^= col[2];
   state[0 * 4 + 3] ^= col[3];
   state[1 * 4 + 3] = col[0];
   state[1 * 4 + 3] ^= gf_mul[col[1]][0];
   state[1 * 4 + 3] ^= gf_mul[col[2]][1];
   state[1 * 4 + 3] ^= col[3];
   state[2 * 4 + 3] = col[0];
   state[2 * 4 + 3] ^= col[1];
   state[2 * 4 + 3] ^= gf_mul[col[2]][0];
   state[2 * 4 + 3] ^= gf_mul[col[3]][1];
   state[3 * 4 + 3] = gf_mul[col[0]][1];
   state[3 * 4 + 3] ^= col[1];
   state[3 * 4 + 3] ^= col[2];
   state[3 * 4 + 3] ^= gf_mul[col[3]][0];
}
...
void InvMixColumns(uchar state[])
{
   ...
   col[2] = state[2 * 4 + 0];
   col[3] = state[3 * 4 + 0];
   state[0 * 4 + 0] = gf_mul[col[0]][5];
   state[0 * 4 + 0] ^= gf_mul[col[1]][3];
   state[0 * 4 + 0] ^= gf_mul[col[2]][4];
   state[0 * 4 + 0] ^= gf_mul[col[3]][2];
   state[1 * 4 + 0] = gf_mul[col[0]][2];
   state[1 * 4 + 0] ^= gf_mul[col[1]][5];
   state[1 * 4 + 0] ^= gf_mul[col[2]][3];
   state[1 * 4 + 0] ^= gf_mul[col[3]][4];
   state[2 * 4 + 0] = gf_mul[col[0]][4];
   state[2 * 4 + 0] ^= gf_mul[col[1]][2];
   state[2 * 4 + 0] ^= gf_mul[col[2]][5];
   state[2 * 4 + 0] ^= gf_mul[col[3]][3];
   state[3 * 4 + 0] = gf_mul[col[0]][3];
   state[3 * 4 + 0] ^= gf_mul[col[1]][4];
   state[3 * 4 + 0] ^= gf_mul[col[2]][2];
   state[3 * 4 + 0] ^= gf_mul[col[3]][5];
   // Column 2
   col[0] = state[0 * 4 + 1];
   col[1] = state[1 * 4 + 1];
   col[2] = state[2 * 4 + 1];
   col[3] = state[3 * 4 + 1];
   state[0 * 4 + 1] = gf_mul[col[0]][5];
   state[0 * 4 + 1] ^= gf_mul[col[1]][3];
   state[0 * 4 + 1] ^= gf_mul[col[2]][4];
   state[0 * 4 + 1] ^= gf_mul[col[3]][2];
   state[1 * 4 + 1] = gf_mul[col[0]][2];
   state[1 * 4 + 1] ^= gf_mul[col[1]][5];
   state[1 * 4 + 1] ^= gf_mul[col[2]][3];
   state[1 * 4 + 1] ^= gf_mul[col[3]][4];
   state[2 * 4 + 1] = gf_mul[col[0]][4];
   state[2 * 4 + 1] ^= gf_mul[col[1]][2];
   state[2 * 4 + 1] ^= gf_mul[col[2]][5];
   state[2 * 4 + 1] ^= gf_mul[col[3]][3];
   state[3 * 4 + 1] = gf_mul[col[0]][3];
   state[3 * 4 + 1] ^= gf_mul[col[1]][4];
   state[3 * 4 + 1] ^= gf_mul[col[2]][2];
   state[3 * 4 + 1] ^= gf_mul[col[3]][5];
   // Column 3
   col[0] = state[0 * 4 + 2];
   col[1] = state[1 * 4 + 2];
   col[2] = state[2 * 4 + 2];
   col[3] = state[3 * 4 + 2];
   state[0 * 4 + 2] = gf_mul[col[0]][5];
   state[0 * 4 + 2] ^= gf_mul[col[1]][3];
   state[0 * 4 + 2] ^= gf_mul[col[2]][4];
   state[0 * 4 + 2] ^= gf_mul[col[3]][2];
   state[1 * 4 + 2] = gf_mul[col[0]][2];
   state[1 * 4 + 2] ^= gf_mul[col[1]][5];
   state[1 * 4 + 2] ^= gf_mul[col[2]][3];
   state[1 * 4 + 2] ^= gf_mul[col[3]][4];
   state[2 * 4 + 2] = gf_mul[col[0]][4];
   state[2 * 4 + 2] ^= gf_mul[col[1]][2];
   state[2 * 4 + 2] ^= gf_mul[col[2]][5];
   state[2 * 4 + 2] ^= gf_mul[col[3]][3];
   state[3 * 4 + 2] = gf_mul[col[0]][3];
   state[3 * 4 + 2] ^= gf_mul[col[1]][4];
   state[3 * 4 + 2] ^= gf_mul[col[2]][2];
   state[3 * 4 + 2] ^= gf_mul[col[3]][5];
   // Column 4
   col[0] = state[0 * 4 + 3];
   col[1] = state[1 * 4 + 3];
   col[2] = state[2 * 4 + 3];
   col[3] = state[3 * 4 + 3];
   state[0 * 4 + 3] = gf_mul[col[0]][5];
   state[0 * 4 + 3] ^= gf_mul[col[1]][3];
   state[0 * 4 + 3] ^= gf_mul[col[2]][4];
   state[0 * 4 + 3] ^= gf_mul[col[3]][2];
   state[1 * 4 + 3] = gf_mul[col[0]][2];
   state[1 * 4 + 3] ^= gf_mul[col[1]][5];
   state[1 * 4 + 3] ^= gf_mul[col[2]][3];
   state[1 * 4 + 3] ^= gf_mul[col[3]][4];
   state[2 * 4 + 3] = gf_mul[col[0]][4];
   state[2 * 4 + 3] ^= gf_mul[col[1]][2];
   state[2 * 4 + 3] ^= gf_mul[col[2]][5];
   state[2 * 4 + 3] ^= gf_mul[col[3]][3];
   state[3 * 4 + 3] = gf_mul[col[0]][3];
   state[3 * 4 + 3] ^= gf_mul[col[1]][4];
   state[3 * 4 + 3] ^= gf_mul[col[2]][2];
   state[3 * 4 + 3] ^= gf_mul[col[3]][5];
}
...
void aes_encrypt(uchar *state, uint *key, int keysize)
{
...
void aes_decrypt(uchar *state, uint *key, int keysize)
{
